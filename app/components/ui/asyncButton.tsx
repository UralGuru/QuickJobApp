...
type RenderPropFunction = (state: PressableStateCallbackType) => React.ReactNode;

type AsyncButtonProps = PressableProps & {
  children: React.ReactNode | RenderPropFunction | (React.ReactNode | RenderPropFunction)[];
};
